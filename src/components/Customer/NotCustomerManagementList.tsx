...
interface NotCustomerManagementListProps {
  searchText: string;
  statusFilter: string;
}

const NotCustomerManagementList: React.FC<NotCustomerManagementListProps> = ({ searchText, statusFilter }) => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const filteredByRole = data.result.content.filter((user: User) => user.roles.some((role) => role.name === "STAFF"));
...
export default NotCustomerManagementList;
